 ...
 */
final class Version20230223140838 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pictures (id INT NOT NULL, product_id INT DEFAULT NULL, pictures VARCHAR(255) NOT NULL, alt VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
